...
# 
# Data da Criação: 24/10/2019 21:20
#
# Descrição: O script fará um backup compactado do diretório
...
if [ "$DAYS7" ]
then
	echo "Já foi gerado um backup do diretório $HOME nos último 7 dias."
